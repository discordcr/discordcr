...
client = Discord::Client.new(token: "Bot MjI5NDU5NjgxOTU1NjUyMzM3.Cpnz31.GQ7K9xwZtvC40y8MPY3eTqjEIXm", client_id: 229459681955652337_u64, cache: true)

client.on_guild_member_add do |payload|
  # get the guild/server information
  guild = client.cache.resolve_guild(payload.guild_id)
